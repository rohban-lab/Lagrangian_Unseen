...
class AlexNetFeatureModelWithInput(FeatureModel):
    def __init__(self, alexnet_model, n):
        super().__init__()
        self.normalizer = ImageNetNormalizer()
        self.model = alexnet_model.eval()
    ...
    def features(self, x):
        ...
        x_layer5 = self.layer5(x_layer4)
        return (x, x_layer1, x_layer2, x_layer3, x_layer4, x_layer5)
